                        ...
                        <div class="tab-pane fade show {{ $loop->index === 0 ? 'active' : '' }}"
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.home-section-setting.update') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label for=""
                                            class="col-lg-12 p-0">{{ __('Category Section Two') }}</label>
                                    ...
                                    <div class="form-group">
                                        <label for=""
                                            class="col-lg-12 p-0">{{ __('Category Section Three') }}</label>
                                    ...
                                    <div class="form-group">
                                        <label for=""
                                            class="col-lg-12 p-0">{{ __('Category Section Four') }}</label>
